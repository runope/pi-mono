...
import { Agent, type AgentMessage, type ThinkingLevel } from "@runope/pi-agent-core";
import { type Message, type Model, streamSimple } from "@runope/pi-ai";
 ...
 *
 * // With explicit model
 * import { getModel } from '@runope/pi-ai';
 * const { session } = await createAgentSession({
