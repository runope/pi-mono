...
import type { AgentMessage, MessageRenderer } from "@runope/pi-web-ui";
import { defaultConvertToLlm, registerMessageRenderer } from "@runope/pi-web-ui";
...
declare module "@runope/pi-agent-core" {
